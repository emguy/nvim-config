...
vim.api.nvim_set_hl(0, 'LineNr'             , { ctermfg=cmap['#5F5FFF'], ctermbg=cmap['NOCOLOR'], cterm={} } )
vim.api.nvim_set_hl(0, 'CursorLineNr'       , { ctermfg=cmap['#87FF87'], ctermbg=cmap['#1C1C1C'], cterm={bold=true}, bold=true } )
...
vim.api.nvim_set_hl(0, 'DiffText'           , { ctermfg=cmap['NOCOLOR'], ctermbg=cmap['#D70000'], cterm={bold=true}, bold=true } )
...
vim.api.nvim_set_hl(0, 'NvimTreeOpenedHL'   , { ctermfg=cmap['#AFD787'], ctermbg=cmap['NOCOLOR'], cterm={bold=true} } )
